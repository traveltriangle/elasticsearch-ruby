...
module Elasticsearch6
  module Test
    class SearchTest < ::Elasticsearch6::Test::UnitTestCase
      ...
      context "The Search module" do
        should "have the search method on instance" do
          ...
          assert_instance_of Elasticsearch6::DSL::Search::Search, DummySearchReceiver.new.search
        end
        ...
        should "have the search method on module" do
          ...
          assert_instance_of Elasticsearch6::DSL::Search::Search, Elasticsearch6::DSL::Search.search
        end
      ...
      context "The Search class" do
        ...
        context "with query" do
          ...
          should "take the query as a block" do
            Elasticsearch6::DSL::Search::Query.expects(:new).returns({foo: 'bar'})
            subject.query do; end
            assert_equal({query: { foo: 'bar' }}, subject.to_hash)
          end

          should "allow chaining" do
            assert_instance_of Elasticsearch6::DSL::Search::Search, subject.query(:foo)
            assert_instance_of Elasticsearch6::DSL::Search::Search, subject.query(:foo).query(:bar)
          end
        ...
        context "with filter" do
          ...
          should "take the filter as a block" do
            Elasticsearch6::DSL::Search::Filter.expects(:new).returns({foo: 'bar'})
            subject.filter do; end
            assert_equal({filter: { foo: 'bar' }}, subject.to_hash)
          end

          should "allow chaining" do
            assert_instance_of Elasticsearch6::DSL::Search::Search, subject.filter(:foo)
            assert_instance_of Elasticsearch6::DSL::Search::Search, subject.filter(:foo).filter(:bar)
          end
        ...
        context "with post_filter" do
          ...
          should "allow chaining" do
            assert_instance_of Elasticsearch6::DSL::Search::Search, subject.post_filter(:foo)
            assert_instance_of Elasticsearch6::DSL::Search::Search, subject.post_filter(:foo).post_filter(:bar)
          end
        ...
        context "with aggregations" do
          ...
          should "take the aggregation as a block" do
            Elasticsearch6::DSL::Search::Aggregation.expects(:new).returns({tam: 'tam'})
            subject.aggregation :foo do; end
            assert_equal({aggregations: { foo: { tam: 'tam' } } }, subject.to_hash)
          end

          should "allow chaining" do
            assert_instance_of Elasticsearch6::DSL::Search::Search, subject.aggregation(:foo)
            assert_instance_of Elasticsearch6::DSL::Search::Search, subject.aggregation(:foo).aggregation(:bar)
          end
        ...
        context "with sorting" do
          ...
          should "have a getter method" do
            ...
            subject.sort :foo
            assert_instance_of Elasticsearch6::DSL::Search::Sort, subject.sort
          end
        end
