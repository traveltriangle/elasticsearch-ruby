...
class Elasticsearch6::Extensions::AnsiTest < Elasticsearch6::Test::UnitTestCase
  context "The ANSI extension" do
    setup do
      @client = Elasticsearch6::Client.new
      @client.stubs(:perform_request).returns \
        Elasticsearch6::Transport::Transport::Response.new(200, { "ok" => true, "status" => 200, "name" => "Hit-Maker",
    ...
    should "wrap the response" do
      ...
      assert_instance_of Elasticsearch6::Extensions::ANSI::ResponseBody, response
    ...
    should "call the 'awesome_inspect' method when available and no handler found" do
      @client.stubs(:perform_request).returns \
        Elasticsearch6::Transport::Transport::Response.new(200, {"index-1"=>{"aliases"=>{}}})
