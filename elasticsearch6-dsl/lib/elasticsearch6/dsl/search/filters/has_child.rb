  ...
  module DSL
    module Search
      module Filters
        ...
        #     end
        #
        # @see http://elasticsearch6.org/guide/en/elasticsearch6/reference/current/query-dsl-has-child-filter.html
        #
        class HasChild
          ...
          def query(*args, &block)
            @query = block ? Elasticsearch6::DSL::Search::Query.new(*args, &block) : args.first
            self
          end
