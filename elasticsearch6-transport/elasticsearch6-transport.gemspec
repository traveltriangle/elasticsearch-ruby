...
Gem::Specification.new do |s|
  s.name          = "elasticsearch6-transport"
  ...
  s.homepage      = "https://github.com/elasticsearch6/elasticsearch6-ruby/tree/master/elasticsearch6-transport"
  ...
  s.description = <<-DESC.gsub(/^    /, '')
    Ruby client for Elasticsearch6. See the `elasticsearch6` gem for full integration.
  DESC
end
