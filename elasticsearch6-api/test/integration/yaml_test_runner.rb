...
rest_api_test_source = $client.info['version']['number'] < '2' ? '../../../../tmp/elasticsearch6/rest-api-spec/test' : '../../../../tmp/elasticsearch6/rest-api-spec/src/main/resources/rest-api-spec/test'
        ...
        context '' do
          ...
          should test_name do
            if ENV['CI']
              ...
              $stderr.puts "https://github.com/elasticsearch6/elasticsearch6/blob/#{ref}/rest-api-spec/test/" \
                          + file.gsub(PATH.to_s, ''), ""
            ...
            actions.each do |action|
              ...
              # See https://github.com/elastic/elasticsearch6/issues/21980
