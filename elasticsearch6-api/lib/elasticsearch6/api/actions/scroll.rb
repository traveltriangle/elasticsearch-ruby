module Elasticsearch6
  module API
    module Actions
      ...
      #
      # @see http://www.elasticsearch6.org/guide/en/elasticsearch6/guide/current/scan-scroll.html#scan-scroll
      # @see https://www.elastic.co/guide/en/elasticsearch6/reference/current/search-request-scroll.html
      #
