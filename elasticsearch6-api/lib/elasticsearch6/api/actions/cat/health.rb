  ...
  module API
    module Cat
      module Actions
        ...
        # Display a terse version of the {Elasticsearch6::API::Cluster::Actions#health} API output
        #
        ...
        #
        # @see http://www.elasticsearch6.org/guide/en/elasticsearch6/reference/current/cat-health.html
        #
