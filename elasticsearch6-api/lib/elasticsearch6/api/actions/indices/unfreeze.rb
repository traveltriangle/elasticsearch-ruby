  ...
  module API
    module Indices
      module Actions
        ...
        #
        # @see https://www.elastic.co/guide/en/elasticsearch6/reference/current/frozen-indices.html
        #
        def unfreeze(arguments = {})
          ...
          path = Elasticsearch6::API::Utils.__pathify Elasticsearch6::API::Utils.__listify(index), '_unfreeze'
