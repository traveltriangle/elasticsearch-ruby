module Elasticsearch6
  module API
    module Actions
      ...
      # [query string queries](http://www.elasticsearch6.org/guide/reference/api/search/uri-request/)
      # as the `:q` argument , or by passing the
      # [full request definition](http://www.elasticsearch6.org/guide/reference/api/search/request-body/)
      # in the [Query DSL](http://www.elasticsearch6.org/guide/reference/query-dsl/) as the `:body` argument.
      #
      # @example Search with a simple query string query
      #
      #     client.search index: 'myindex', q: 'title:test'
      #
      # @example Passing a full request definition in the Elasticsearch6's Query DSL as a `Hash`
      #
      ...
      # @return [Hash]
      #
      # @see http://www.elasticsearch6.org/guide/reference/api/search/
      # @see http://www.elasticsearch6.org/guide/reference/api/search/request-body/
      #
