module Elasticsearch6
  module API
    module Actions
      ...
      # [Query DSL](http://www.elasticsearch6.org/guide/reference/query-dsl/) in the `:body` argument.
      #
      ...
      #
      # @see https://www.elastic.co/guide/en/elasticsearch6/reference/current/docs-delete-by-query.html
      #
