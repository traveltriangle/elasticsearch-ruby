...
module Elasticsearch6
  ...
  module API
    ...
    class SourceGenerator < Thor
      ...
      method_option :input,     default: File.expand_path('../../../../tmp/elasticsearch6/rest-api-spec/api/**/*.json', __FILE__), desc: 'Path to directory with JSON API specs'
      ...
      def generate(*files)
        ...
        Dir[@input].each do |file|
          ...
          @http_method      = "Elasticsearch6::API::HTTP_#{@spec['methods'].first}"
