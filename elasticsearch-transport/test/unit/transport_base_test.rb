...
class Elasticsearch6::Transport::Transport::BaseTest < Test::Unit::TestCase

  class EmptyTransport
    include Elasticsearch6::Transport::Transport::Base
  end

  class DummyTransport
    include Elasticsearch6::Transport::Transport::Base
    def __build_connection(host, options={}, block=nil)
      Elasticsearch6::Transport::Transport::Connections::Connection.new :host => host, :connection => Object.new
    end
  end
  ...
  context "Transport::Base" do
    ...
    should "have default serializer" do
      transport = DummyTransport.new
      assert_instance_of Elasticsearch6::Transport::Transport::Base::DEFAULT_SERIALIZER_CLASS, transport.serializer
    end
    ...
    should "have default sniffer" do
      transport = DummyTransport.new
      assert_instance_of Elasticsearch6::Transport::Transport::Sniffer, transport.sniffer
    end
  ...
  context "performing a request" do
    ...
    should "get the connection" do
      ...
      @transport.perform_request 'GET', '/' do; Elasticsearch6::Transport::Transport::Response.new 200, 'OK'; end
    end

    should "raise an error when no connection is available" do
      @transport.expects(:get_connection).returns(nil)
      assert_raise Elasticsearch6::Transport::Transport::Error do
        @transport.perform_request 'GET', '/' do; Elasticsearch6::Transport::Transport::Response.new 200, 'OK'; end
      end
    end
    ...
    should "call the passed block" do
      ...
      @transport.perform_request 'GET', '/' do |connection, url|
        x += 1
        Elasticsearch6::Transport::Transport::Response.new 200, 'OK'
      end
    ...
    should "deserialize a response JSON body" do
      ...
      response = @transport.perform_request 'GET', '/' do
                   Elasticsearch6::Transport::Transport::Response.new 200, '{"foo":"bar"}', {"content-type" => 'application/json'}
                 end
    ...
    should "not deserialize a response string body" do
      ...
      response = @transport.perform_request 'GET', '/' do
                   Elasticsearch6::Transport::Transport::Response.new 200, 'FOOBAR', {"content-type" => 'text/plain'}
                 end
    ...
    should "not deserialize an empty response body" do
      ...
      @transport.serializer.expects(:load).never
      response = @transport.perform_request 'GET', '/' do
                   Elasticsearch6::Transport::Transport::Response.new 200, '', {"content-type" => 'application/json'}
                 end
    ...
    should "raise an error for HTTP status 404" do
      @transport.expects(:get_connection).returns(stub_everything :failures => 1)
      assert_raise Elasticsearch6::Transport::Transport::Errors::NotFound do
        @transport.perform_request 'GET', '/' do
          Elasticsearch6::Transport::Transport::Response.new 404, 'NOT FOUND'
        end
      end
    end
    ...
    should "raise an error for HTTP status 404 with application/json content type" do
      ...
      assert_raise Elasticsearch6::Transport::Transport::Errors::NotFound do
        @transport.perform_request 'GET', '/' do
          Elasticsearch6::Transport::Transport::Response.new 404, 'NOT FOUND', {"content-type" => 'application/json'}
        end
      end
    end
    ...
    should "raise an error on server failure" do
      @transport.expects(:get_connection).returns(stub_everything :failures => 1)
      assert_raise Elasticsearch6::Transport::Transport::Errors::InternalServerError do
        @transport.perform_request 'GET', '/' do
          Elasticsearch6::Transport::Transport::Response.new 500, 'ERROR'
        end
      end
    end
    ...
    should "not raise an error when the :ignore argument has been passed" do
      ...
      assert_raise Elasticsearch6::Transport::Transport::Errors::BadRequest do
        @transport.perform_request 'GET', '/' do
          Elasticsearch6::Transport::Transport::Response.new 400, 'CLIENT ERROR'
        end
      end
  ...
  context "performing a request with retry on status" do
    ...
    should "not retry when the status code does not match" do
      ...
      @block.expects(:call).
             returns(Elasticsearch6::Transport::Transport::Response.new 400, 'Bad Request').
             times(1)
    ...
    should "retry when the status code does match" do
      ...
      @block.expects(:call).
             returns(Elasticsearch6::Transport::Transport::Response.new 500, 'Internal Error').
             times(4)
  ...
  context "logging" do
    ...
    should "log the request and response" do
      ...
      @transport.perform_request 'POST', '_search', {:size => 1}, {:foo => 'bar'} do
                   Elasticsearch6::Transport::Transport::Response.new 200, '{"foo":"bar"}'
                 end
    end
    ...
    should "sanitize password in the URL" do
      ...
      @transport.perform_request('GET', '/') {Elasticsearch6::Transport::Transport::Response.new 200, '{"foo":"bar"}' }
    end

    should "log a failed Elasticsearch6 request as fatal" do
      @block = Proc.new { |c, u| puts "ERROR" }
      @block.expects(:call).returns(Elasticsearch6::Transport::Transport::Response.new 500, 'ERROR')
    ...
    should "not log a failed Elasticsearch6 request as fatal" do
      @block = Proc.new { |c, u| puts "ERROR" }
      @block.expects(:call).returns(Elasticsearch6::Transport::Transport::Response.new 500, 'ERROR')
  ...
  context "tracing" do
    ...
    should "trace a failed Elasticsearch6 request" do
      @block = Proc.new { |c, u| puts "ERROR" }
      @block.expects(:call).returns(Elasticsearch6::Transport::Transport::Response.new 500, 'ERROR')
  ...
  context "reloading connections" do
    ...
    should "log error and continue when timing out while sniffing hosts" do
      @transport.sniffer.expects(:hosts).raises(Elasticsearch6::Transport::Transport::SnifferTimeoutError)
  ...
  context "resurrecting connections" do
    ...
    should "mark connection healthy if it succeeds" do
      ...
      @transport.perform_request('GET', '/') { |connection, url| Elasticsearch6::Transport::Transport::Response.new 200, 'OK' }
    end
  end

  context "errors" do
    should "raise highest-level Error exception for any ServerError" do
      assert_kind_of Elasticsearch6::Transport::Transport::Error, Elasticsearch6::Transport::Transport::ServerError.new
    end
  end
end
