...
$logger.progname = 'elasticsearch6'
...
$tracer.progname = 'elasticsearch6.tracer'
...
if ENV['ELASTIC_PASSWORD']
  ...
  password = begin
    puts "The ELASTIC_PASSWORD environment variable is not set, getting password by running `bin/elasticsearch6-setup-passwords`...".ansi(:faint)
    out = `docker exec -it elasticsearch6-xpack bin/elasticsearch6-setup-passwords auto --batch`
...
rest_api_test_source = '../../../../tmp/elasticsearch6/x-pack/plugin/src/test/resources/rest-api-spec/test'
