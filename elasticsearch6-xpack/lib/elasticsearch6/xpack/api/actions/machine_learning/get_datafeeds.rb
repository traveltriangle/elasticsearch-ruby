    ...
    module API
      module MachineLearning
        module Actions
          ...
          #
          # @see http://www.elastic.co/guide/en/elasticsearch6/reference/current/ml-get-datafeed.html
          #
          def get_datafeeds(arguments={})
            ...
            path   = Elasticsearch6::API::Utils.__pathify "_xpack/ml/datafeeds", arguments[:datafeed_id]
