    ...
    module API
      module MachineLearning
        module Actions
          ...
          #
          # @see http://www.elastic.co/guide/en/elasticsearch6/reference/current/ml-revert-snapshot.html
          #
          def revert_model_snapshot(arguments={})
            ...
            path   = Elasticsearch6::API::Utils.__pathify "_xpack/ml/anomaly_detectors", arguments[:job_id], "model_snapshots", arguments[:snapshot_id], "_revert"
