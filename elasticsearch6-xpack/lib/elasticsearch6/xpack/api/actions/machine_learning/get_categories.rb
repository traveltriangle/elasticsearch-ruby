    ...
    module API
      module MachineLearning
        module Actions
          ...
          #
          # @see http://www.elastic.co/guide/en/elasticsearch6/reference/current/ml-get-category.html
          #
          def get_categories(arguments={})
            ...
            path   = Elasticsearch6::API::Utils.__pathify "_xpack/ml/anomaly_detectors", arguments[:job_id], "results/categories", arguments[:category_id]
