...
YAML_FILES_DIRECTORY = "#{File.expand_path(File.dirname('..'), '..')}" +
                          "/tmp/elasticsearch6/x-pack/plugin/src/test/resources/rest-api-spec/test"
SINGLE_TEST = if ENV['SINGLE_TEST'] && !ENV['SINGLE_TEST'].empty?
                ["#{File.expand_path(File.dirname('..'), '..')}" +
                     "/tmp/elasticsearch6/x-pack/plugin/src/test/resources/rest-api-spec/test/#{ENV['SINGLE_TEST']}"]
              end
