...
Gem::Specification.new do |s|
  ...
  s.homepage      = "http://github.com/elasticsearch6/elasticsearch6-ruby"
  ...
  s.add_dependency "elasticsearch6-transport", '6.3.0'
  s.add_dependency "elasticsearch6-api",       '6.3.0'
