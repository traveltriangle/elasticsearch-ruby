      ...
      should "start and stop #{build.to_s}" do
        ...
        begin
          Elasticsearch6::Extensions::Test::Cluster.start \
            command: PATH_TO_BUILDS.join(build.join('bin/elasticsearch6')).to_s,
            port: 9260,
            cluster_name: 'elasticsearch6-ext-integration-test',
            path_data: '/tmp/elasticsearch6-ext-integration-test'
